<template>
    <!--  TODO: move navbar to Global Component  -->
    <!--  TODO: make it at the top  -->
    <nav class="sticky top-0 left-0 bg-white border-gray-200 px-2 sm:px-4 py-2.5 shadow-sm dark:bg-gray-800">
